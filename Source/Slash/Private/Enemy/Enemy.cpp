...
void AEnemy::Die()
{
	...
	if (ASlashCharacter* SlashCharacter = Cast<ASlashCharacter>(UGameplayStatics::GetPlayerCharacter(this, 0)))
	{
		SlashCharacter->ResetLockOn();
	}
...
void AEnemy::SpawnSoul()
{
	...
	{
		ASoul* SpawnSoul = GetWorld()->SpawnActor<ASoul>(SoulClass, GetActorLocation() - SoulOffset, GetActorRotation());
		if (SpawnSoul)
		{
